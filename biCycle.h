/*
	...
	Описание библиотеки biCycle v1.0
...
/*
	...
	указатель на флаг завершенности функции (использующийся для сигнализации о выполнении последовательности).
...
public:
	...
	void Execute()
	{
		...
		for (auto sequence : sequences)
		{
			...
			{
				if (sequences[i].report != nullptr) { *sequences[i].report = true; } //report из обертки функции иногда может быть nullptr, потому добавляем проверку и сигналим об успехе
